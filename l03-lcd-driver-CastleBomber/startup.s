...
;
; Description: 
; This is the startup file which sets up all of the vectors needed
; for the processor to f(x). 
; It also sets up the start of the program by
; loading the address of the code "main" && jumping to it.
; 	
; Note that there is no setup of a runtime environment. 
...
; All we do is load the address of 
; "main" && branch to it.
;******************************************************************************
Reset_Handler	PROC
